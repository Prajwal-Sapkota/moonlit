          ...
          <div className="grid grid-cols-2 gap-8 h-fit -ml-10 mr-20">
            <div className="space-y-2">
              ...
              <div id="overview" className="space-y-2 text-sm">
                <a href="#" className="block hover:text-[#b99d75]">Overview</a>
                <a href="#" className="block hover:text-[#b99d75]">Winter Activities</a>
                <a href="#" className="block hover:text-[#b99d75]">Summer Activities</a>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div id="summer" className="space-y-2 text-sm">
                <a href="#" className="block hover:text-[#b99d75]">Hiking</a>
                <a href="#" className="block hover:text-[#b99d75]">Running & Walking</a>
                <a href="#" className="block hover:text-[#b99d75]">Mountain Bike</a>
                <a href="#" className="block hover:text-[#b99d75]">Racing Bike</a>
                <a href="#" className="block hover:text-[#b99d75]">Golf Courses</a>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div id="winter" className="space-y-2 text-sm">
                <a href="#" className="block hover:text-[#b99d75]">Ski & Snowboard</a>
                <a href="#" className="block hover:text-[#b99d75]">Freeriding</a>
                <a href="#" className="block hover:text-[#b99d75]">Winter Hiking</a>
                <a href="#" className="block hover:text-[#b99d75]">Snowshoeing</a>
                <a href="#" className="block hover:text-[#b99d75]">Paraglider Exercises</a>
                <a href="#" className="block hover:text-[#b99d75]">Sledding</a>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div id="others" className="space-y-2 text-sm">
                <a href="#" className="block hover:text-[#b99d75]">Art & Museum</a>
                <a href="#" className="block hover:text-[#b99d75]">Music</a>
              </div>
            </div>
